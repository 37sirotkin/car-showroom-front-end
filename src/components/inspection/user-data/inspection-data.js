...
import "./inspection-data.scss";
import {Button, Form, Input, InputNumber} from "antd";
import {useDispatch} from "react-redux";
import {postTestDrive} from "../../redux/actions/testDriveAction";
import {postInspection} from "../../redux/actions/inspectionAction";

const InspectionData = ({selectCar, selectPath, selectTime}) => {
    ...
    const submitTestDrive = () => {
        ...
        dispatch(postInspection(postObj));
